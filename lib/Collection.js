...
class Collection {
  ...
  push(key, data) {
    ...
    if (!(currentData instanceof Array) || !currentData) throw 'Tried to push data to a value with type not of array';
    let newData = currentData ? currentData : data;
    console.log(newData.push(data));
